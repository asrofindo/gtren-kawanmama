    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <hr>
                <form action="<?= base_url('setting') ?>/api/add" method="post" enctype="multipart/form-data">
                    <div class="mb-4">
                        <label for="offer" class="form-label">Nama </label>
                        <input type="text" placeholder="Tulis Disini" name="nama" class="form-control" id="offer" />
                    </div>
                     <div class="mb-4">
                        <label for="description" class="form-label">Token</label>
                        <input type="text" placeholder="Tulis Disini" name="token" class="form-control" id="description" />
                    </div>
                    <div class="d-grid">
                            ...
                            <tbody>
                                <?php foreach ($apis as $key => $api): ?>
                                    <tr>
                                        ...
                                        <td><b><?= $api->token ?></b></td>
                                        <td>
                                            <a href="<?= base_url('api/edit/'.$api->id) ?>" class="btn btn-brand rounded btn-sm font-sm">
                                                <i class="material-icons md-edit"></i>
                                                Edit
                                            </a>
                                            <a href="<?= base_url('api/delete/'.$api->id) ?>" class="btn btn-light btn-sm font-sm rounded">
