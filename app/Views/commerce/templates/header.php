            ...
            <div class="container">
                <div class="header-wrap header-space-between">
                    <div class="logo logo-width-4" style=" width: 300px">
                        <a href="<?= base_url() ?>" class="w-100 p-0 d-flex align-items-center"><img class="w-25" src="<?= base_url() ?>/uploads/banner/<?= profile() == null ? '': profile()->photo ?>" alt="logo"><h5 style="margin-left:10px">Gtren Indonesia</h5></a>
                    </div>
